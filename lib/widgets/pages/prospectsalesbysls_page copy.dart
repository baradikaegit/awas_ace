                                                                                              ...
                                                                                              child: Row(
                                                                                                children: <Widget>[
                                                                                                  Checkbox(
                                                                                                    ...
                                                                                                    value: checkedItems[currentIndex],
                                                                                                    onChanged: (bool? value) {
                                                                                                      setState(() {
                                                                                                        checkedItems[currentIndex] = value!;

                                                                                                        checkControllers[currentIndex].text = value ? "1" : "0";
                                                                                                        // print(
                                                                                                        //     "Checkbox diubah: ${item.prospectCode} -> ${checkControllers[index].text}");
                                                                                                        // if (currentIndex < checkControllers.length) {
                                                                                                        //   checkedItems[currentIndex] = value!;
                                                                                                        //   checkControllers[currentIndex].text = value ? "1" : "0";

                                                                                                        //   print("Checkbox diubah: ${item.prospectCode} -> ${checkControllers[currentIndex].text}");
                                                                                                        // } else {
                                                                                                        //   print("Indeks $currentIndex tidak valid!");
                                                                                                        // }
                                                                                                      });
                                                                                                    },
                                                                                                  ),
