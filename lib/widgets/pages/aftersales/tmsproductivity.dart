...
class TMSProductivityPage extends StatefulWidget {
  final Object? linkPageObj;
  const TMSProductivityPage({super.key, required this.linkPageObj});

  static const String routeName = "/tMSProductivityPage";
  @override
  State<TMSProductivityPage> createState() => _TMSProductivityPageState();
}
...
class _TMSProductivityPageState extends State<TMSProductivityPage> {
  ...
  List<ListRptAfterSlsTMSPRoductivityResponse> listRptTMSProductivityRes = [];
              ...
              children: [
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptTMSProductivity =
                        ref.watch(reportTMSProductivity(linkPageObj));
                            ...
                            children: [
                                                      ...
                                                      children: [
                                                        Align(
                                                          alignment: Alignment
                                                              .centerLeft,
                                                          child: Text(
                                                            "Periode : ${dataSelectOpt.listRptTMSProductivity![0].monthID} ${dataSelectOpt.listRptTMSProductivity![0].year}",
                                                            style: TextStyle(
                                                              color: const Color
                                                                  .fromARGB(
                                                                255,
                              ...
                              Expanded(
                                child: RefreshIndicator(
                                  onRefresh: () async {
                                    return ref.refresh(reportTMSProductivity(
                                        linkPageObj.toString()));
                                  },
                                  child: rptTMSProductivity.when(
                                    data: (dataTMSProductivity) {
                                      listRptTMSProductivityRes.clear();
                                      listRptTMSProductivityRes
                                          .add(dataTMSProductivity);

                                      return (dataTMSProductivity
                                                  .listRptTMSProductivity !=
                                              null)
                                          ? dataTMSProductivity
                                                  .listRptTMSProductivity!
                                                                ...
                                                                child:
                                                                  ...
                                                                  annotations: [
                                                                    CircularChartAnnotation(
                                                                      widget:
                                                                        ...
                                                                        textAlign:
                                                                            TextAlign.center,
                                                                        "ASTRIDO \n${dataTMSProductivity.listRptTMSProductivity![0].persen}%",
                                                                        style:
                                                                            TextStyle(
                                                                          color:
                                                                              Colors.white,
                                                                  ...
                                                                  series: <CircularSeries>[
                                                                    DoughnutSeries<
                                                                        DataTMSProductivity,
                                                                        String>(
                                                                      dataLabelMapper: (DataTMSProductivity data, _) => data
                                                                          .dataLabel
                                                                          .toString(),
                                                                      dataSource:
                                                                          toDynamic(
                                                                              listRptTMSProductivityRes[0].listRptTMSProductivity!),
                                                                      xValueMapper:
                                                                          (DataTMSProductivity data, _) =>
                                                                              data.x,
                                                                      yValueMapper:
                                                                          (DataTMSProductivity data, _) =>
                                                                              data.y,
                                                                    ...
                                                                    cells: <DataCell>[
                                                                      DataCell(
                                                                        InkWell(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              dataRptTMSProductivity.headerCode,
                                                                      ...
                                                                      DataCell(
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            dataRptTMSProductivity.tms.toString(),
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                            style:
                                                                                textStyleColorWhite,
                                                                      ...
                                                                      DataCell(
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            dataRptTMSProductivity.productivity.toString(),
                                                                            textAlign:
                                                                                TextAlign.right,
                                                                            style:
                                                                                textStyleColorWhite,
                                                                      ...
                                                                      DataCell(
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            dataRptTMSProductivity.persen.toString(),
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                            style:
                                                                                textStyleColorGold,
...
class DataTMSProductivity {
  String x;
  double y;
  int dataLabel;
  Color color;

  DataTMSProductivity(this.x, this.y, this.dataLabel, this.color);
}
  ...
  List<DataTMSProductivity> chartData = <DataTMSProductivity>[
    ...
    DataTMSProductivity(
      ...
      objList[0].productivity!.toDouble() > 0 || objList[0].tms > 0
          ...
          : 50,
      objList[0].productivity!.toInt() > 0
