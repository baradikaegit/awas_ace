...
class ProspekSaGRPage extends StatefulWidget {
  final Object? linkPageObj;
  const ProspekSaGRPage({super.key, required this.linkPageObj});

  static const String routeName = "/prospekSaGRPage";
  @override
  State<ProspekSaGRPage> createState() => _ProspekSaGRPageState();
}
...
class _ProspekSaGRPageState extends State<ProspekSaGRPage> {
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptProspekSaGR =
                        ref.watch(reportProspekSaGR(linkPageObj));
                            ...
                            children: [
                              ...
                              Expanded(
                                child: RefreshIndicator(
                                  onRefresh: () async {
                                    return ref.refresh(reportProspekSaGR(
                                                              ...
                                                              rows: List<
                                                                ...
                                                                (indexObj) {
                                                                  ...
                                                                  var textStyleDataTable =
                                                                      TextStyle(
                                                                    color: dataProspekSaGR.listRptProspekSaGR![indexObj].headerName ==
                                                                            'TOTAL'
                                                                        ? const Color
                                                                            .fromARGB(
                                                                            255,
                                                                  ...
                                                                  return DataRow(
                                                                    ...
                                                                    cells: <DataCell>[
                                                                      DataCell(
                                                                        InkWell(
                                                                          onTap: dataProspekSaGR.listRptProspekSaGR![indexObj].headerName == 'TOTAL'
                                                                              ? () {}
                                                                              : () {
                                                                                  var month = dataProspekSaGR.listRptProspekSaGR![indexObj].month.toString();
                                                                                  var year = dataProspekSaGR.listRptProspekSaGR![indexObj].year.toString();
                                                                                  var periodTipe = dataProspekSaGR.listRptProspekSaGR![indexObj].periodTipe;
                                                                                  var branchCode = dataProspekSaGR.listRptProspekSaGR![indexObj].headerName;

                                                                                  Navigator.pushNamed(
                                                                                    context,
                                                                                    ProspekSaGRBySANamePage.routeName,
