...
class MonitoringPoinBySvcPage extends StatefulWidget {
  final Object? linkPageObj;
  const MonitoringPoinBySvcPage({super.key, required this.linkPageObj});

  static const String routeName = "/monitoringPoinBySvcPage";
  @override
  State<MonitoringPoinBySvcPage> createState() =>
      _MonitoringPoinBySvcPageState();
}

class _MonitoringPoinBySvcPageState extends State<MonitoringPoinBySvcPage> {
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptMonitoringPoin =
                        ref.watch(reportMonitPoinBySvc(linkPageObj));
                            ...
                            children: [
                              ...
                              Expanded(
                                child: RefreshIndicator(
                                  onRefresh: () async {
                                    return ref.refresh(
                                      reportMonitPoinBySvc(linkPageObj),
                                    );
                                  },
                                  child: rptMonitoringPoin.when(
                                                                        ...
                                                                        DataRow(
                                                                          ...
                                                                          cells: <DataCell>[
                                                                            DataCell(
                                                                              InkWell(
                                                                                onTap: () {
                                                                                  String userCode = dataMonitoringPoin.listRptGeneralMonitoringPoin![i].headerCode;
                                                                                  int tipe = 0;

                                                                                  Navigator.pushNamed(
                                                                                    context,
                                                                                    MonitoringPoinHistoryPage.routeName,
                                                                                    arguments: '$userCode/$tipe',
                                                                                  );
                                                                                },
                                                                                child: Padding(
                                                                            ...
                                                                            DataCell(
                                                                              Align(
                                                                                alignment: Alignment.centerLeft,
                                                                                child: Text(
                                                                                  dataMonitoringPoin.listRptGeneralMonitoringPoin![i].headerGroup,
                                                                                  textAlign: TextAlign.left,
                                                                                  style: textStyleColorWhite,
                                                                                ),
                                                                              ),
