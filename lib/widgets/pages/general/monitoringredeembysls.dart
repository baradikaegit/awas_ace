...
class MonitoringRedeemBySalesPage extends StatefulWidget {
  final Object? linkPageObj;
  const MonitoringRedeemBySalesPage({super.key, required this.linkPageObj});

  static const String routeName = "/monitoringRedeemBySalesPage";
  @override
  State<MonitoringRedeemBySalesPage> createState() =>
      _MonitoringRedeemBySalesPageState();
}

class _MonitoringRedeemBySalesPageState
    extends State<MonitoringRedeemBySalesPage> with TickerProviderStateMixin {
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptMonitoringRedeem =
                        ref.watch(reportMonitRedeemBySales(linkPageObj));
                            ...
                            children: [
                              ...
                              Expanded(
                                child: RefreshIndicator(
                                  onRefresh: () async {
                                    return ref.refresh(
                                      reportMonitRedeemBySales(linkPageObj),
                                    );
                                  },
                                  child: rptMonitoringRedeem.when(
