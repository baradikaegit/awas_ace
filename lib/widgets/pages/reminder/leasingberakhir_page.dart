...
class ReminderLeasingBerakhirPage extends StatefulWidget {
  ...
  static const String routeName = "/reminderLeasingBerakhirPage";

  @override
  State<ReminderLeasingBerakhirPage> createState() =>
      _ReminderLeasingBerakhirPageState();
}

class _ReminderLeasingBerakhirPageState
    extends State<ReminderLeasingBerakhirPage> {
            ...
            children: [
              ...
              Consumer(
                builder: (context, WidgetRef ref, child) {
                  final dataLeasingberakhir = ref.watch(leasingBerakhir);
