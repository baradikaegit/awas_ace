...
class ProspekSaBPBySANamePage extends StatefulWidget {
  final Object? linkPageObj;
  const ProspekSaBPBySANamePage({super.key, required this.linkPageObj});

  static const String routeName = "/prospekSaBPBySANamePage";
  @override
  State<ProspekSaBPBySANamePage> createState() =>
      _ProspekSaBPBySANamePageState();
}
...
class _ProspekSaBPBySANamePageState extends State<ProspekSaBPBySANamePage> {
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptProspekSaBP =
                        ref.watch(reportProspekSaBPBySAName(linkPageObj));
