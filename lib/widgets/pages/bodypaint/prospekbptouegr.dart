...
class ProspekBPtoUeGRPage extends StatefulWidget {
  final Object? linkPageObj;
  const ProspekBPtoUeGRPage({super.key, required this.linkPageObj});

  static const String routeName = "/prospekBPtoUeGRPage";
  @override
  State<ProspekBPtoUeGRPage> createState() => _ProspekBPtoUeGRPageState();
}
...
class _ProspekBPtoUeGRPageState extends State<ProspekBPtoUeGRPage> {
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptProspekBPtoUeGR =
                        ref.watch(reportProspekBPtoUeGR(linkPageObj));
                            ...
                            children: [
                              ...
                              Expanded(
                                child: RefreshIndicator(
                                  onRefresh: () async {
                                    return ref.refresh(reportProspekBPtoUeGR(
                                                              ...
                                                              rows: List<
                                                                ...
                                                                (indexObj) {
                                                                  ...
                                                                  var textStyleDataTable =
                                                                      TextStyle(
                                                                    color: dataProspekBPtoUeGR.listRptProspekBPtoUeGR![indexObj].headerName ==
                                                                            'TOTAL'
                                                                        ? const Color
                                                                            .fromARGB(
                                                                            255,
                                                                  ...
                                                                  return DataRow(
                                                                    ...
                                                                    cells: <DataCell>[
                                                                      DataCell(
                                                                        InkWell(
                                                                          onTap: dataProspekBPtoUeGR.listRptProspekBPtoUeGR![indexObj].headerName == 'TOTAL'
                                                                              ? () {}
                                                                              : () {
                                                                                  var month = dataProspekBPtoUeGR.listRptProspekBPtoUeGR![indexObj].month.toString();
                                                                                  var year = dataProspekBPtoUeGR.listRptProspekBPtoUeGR![indexObj].year.toString();
                                                                                  var periodTipe = dataProspekBPtoUeGR.listRptProspekBPtoUeGR![indexObj].periodTipe;
                                                                                  var branchCode = dataProspekBPtoUeGR.listRptProspekBPtoUeGR![indexObj].headerName;
