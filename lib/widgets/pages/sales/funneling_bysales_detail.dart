...
class FunnelingSalesDetailPage extends StatefulWidget {
  final Object? linkPageObj;
  const FunnelingSalesDetailPage({super.key, required this.linkPageObj});

  static const String routeName = "/funnelingSalesDetailPage";

  @override
  State<FunnelingSalesDetailPage> createState() =>
      _FunnelingSalesDetailPageState();
}
...
class _FunnelingSalesDetailPageState extends State<FunnelingSalesDetailPage> {
              ...
              children: [
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptFunneling = ref
                        .watch(reportFunnelingBySalesDetailList(linkPageObj));
                            ...
                            children: [
                                                          ...
                                                          onChanged: (String?
                                                            ...
                                                            setState(() {
                                                              ...
                                                              var linkResultPeriodTipe =
                                                                  '$monthNow/$yearNow/$tipePeriode/$refId/$branchCode/$ssCode/$salesCode';
                                                        ...
                                                        child: DropdownButton2<
                                                          ...
                                                          onChanged: (String?
                                                            ...
                                                            setState(() {
                                                              ...
                                                              var linkResultMonth =
                                                                  '$monthSelected/$yearNow/$periodTipe/$refId/$branchCode/$ssCode/$salesCode';
                                                        ...
                                                        child: DropdownButton2<
                                                          ...
                                                          onChanged: (String?
                                                            ...
                                                            setState(() {
                                                              ...
                                                              var linkResultYear =
                                                                  '$monthNow/$yearSelected/$periodTipe/$refId/$branchCode/$ssCode/$salesCode';
                                                  ...
                                                  child:
                                                    ...
                                                    onChanged: (value) {
                                                      setState(() {
                                                        ...
                                                        var linkResultRef =
                                                            '$monthNow/$yearNow/$periodTipe/$idRef/$branchCode/$ssCode/$salesCode';
                              ...
                              Expanded(
                                child: RefreshIndicator(
                                  onRefresh: () async {
                                    return ref.refresh(
                                        reportFunnelingBySalesDetailList(
