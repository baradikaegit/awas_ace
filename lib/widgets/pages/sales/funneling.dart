                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    String monthSelected =
                        rptFunneling.value?.listRptFunneling!.length != null
                            ? (linkPageObj == '$monthNow/$yearNow')
                                ? DateFormat('M').format(DateTime.now())
                                : rptFunneling.value!.listRptFunneling![0].month
                                    .toString()
                            : '';
                    ...
                    String yearSelected =
                        rptFunneling.value?.listRptFunneling!.length != null
                            ? (linkPageObj == '$monthNow/$yearNow')
                                ? DateFormat('yyyy').format(DateTime.now())
                                : rptFunneling.value!.listRptFunneling![0].year
                                    .toString()
                            : '';
