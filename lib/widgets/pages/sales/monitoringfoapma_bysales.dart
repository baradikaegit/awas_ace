...
class MonitFoaPMABySalesPage extends StatefulWidget {
  final Object? linkPageObj;
  const MonitFoaPMABySalesPage({super.key, required this.linkPageObj});

  static const String routeName = "/monitFoaPMABySalesPage";
  @override
  State<MonitFoaPMABySalesPage> createState() => _MonitFoaPMABySalesPageState();
}
...
class _MonitFoaPMABySalesPageState extends State<MonitFoaPMABySalesPage> {
              ...
              children: [
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptfoaPMA =
                        ref.watch(reportMonitoringFoaPMABySls(linkPageObj));
                                                            ...
                                                            onChanged: (String?
                                                              ...
                                                              setState(() {
                                                                ...
                                                                var linkResultPeriodTipe =
                                                                    '$monthNow/$yearNow/$tipePeriode/$tipeCust/$branchCode/$ssCode';

                                                                Navigator
                                                                    .pushReplacementNamed(
                                                                  context,
                                                                  MonitFoaPMABySalesPage
                                                                      .routeName,
                                                                  arguments:
                                                          ...
                                                          child:
                                                            ...
                                                            onChanged: (String?
                                                              ...
                                                              setState(() {
                                                                ...
                                                                var linkResultMonth =
                                                                    '$monthSelected/$yearNow/$periodTipe/$tipeCust/$branchCode/$ssCode';
                                                          ...
                                                          child:
                                                            ...
                                                            onChanged: (String?
                                                              ...
                                                              setState(() {
                                                                ...
                                                                var linkResultYear =
                                                                    '$monthNow/$yearSelected/$periodTipe/$tipeCust/$branchCode/$ssCode';
                                                          ...
                                                          child:
                                                            ...
                                                            onChanged: (String?
                                                              ...
                                                              setState(() {
                                                                ...
                                                                var linkResultTipeCust =
                                                                    '$monthNow/$yearNow/$periodTipe/$tipeCust/$branchCode/$ssCode';
                                            ...
                                            AppBar(
                                              ...
                                              title: Padding(
                                                ...
                                                child: Column(
                                                  children: [
                                                    Text(
                                                      'Cabang ${dataSelectOpt.listMonitoringFoaPMA![0].title}',
                                                      maxLines: 2,
                                                      overflow:
