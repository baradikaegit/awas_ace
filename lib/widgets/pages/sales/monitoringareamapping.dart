...
class MonitAreaMappingPage extends StatefulWidget {
  const MonitAreaMappingPage({super.key});
  static const String routeName = "/monitAreaMappingPage";
  @override
  State<MonitAreaMappingPage> createState() => _MonitAreaMappingPageState();
}

class _MonitAreaMappingPageState extends State<MonitAreaMappingPage> {
