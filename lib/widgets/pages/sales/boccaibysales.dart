                                                                      ...
                                                                      DataCell(
                                                                        InkWell(
                                                                          onTap: dataBocCai.listBocCaiBySales![indexObj].headerCode == 'TOTAL'
                                                                              ? () {}
                                                                              : () {
                                                                                  var month = dataBocCai.listBocCaiBySales![indexObj].month.toString();
                                                                                  var year = dataBocCai.listBocCaiBySales![indexObj].year.toString();
                                                                                  var periodTipe = dataBocCai.listBocCaiBySales![indexObj].periodTipe;
                                                                                  var branchCode = dataBocCai.listBocCaiBySales![indexObj].headerCode;
