...
class MonitFoaPMABySSPage extends StatefulWidget {
  final Object? linkPageObj;
  const MonitFoaPMABySSPage({super.key, required this.linkPageObj});

  static const String routeName = "/monitFoaPMABySSPage";
  @override
  State<MonitFoaPMABySSPage> createState() => _MonitFoaPMABySSPageState();
}
...
class _MonitFoaPMABySSPageState extends State<MonitFoaPMABySSPage> {
              ...
              children: [
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptfoaPMA =
                        ref.watch(reportMonitoringFoaPMABySS(linkPageObj));
                                                            ...
                                                            onChanged: (String?
                                                              ...
                                                              setState(() {
                                                                ...
                                                                var linkResultPeriodTipe =
                                                                    '$monthNow/$yearNow/$tipePeriode/$tipeCust/$branchCode';
                                                          ...
                                                          child:
                                                            ...
                                                            onChanged: (String?
                                                              ...
                                                              setState(() {
                                                                ...
                                                                var linkResultMonth =
                                                                    '$monthSelected/$yearNow/$periodTipe/$tipeCust/$branchCode';
                                                          ...
                                                          child:
                                                            ...
                                                            onChanged: (String?
                                                              ...
                                                              setState(() {
                                                                ...
                                                                var linkResultYear =
                                                                    '$monthNow/$yearSelected/$periodTipe/$tipeCust/$branchCode';
                                                          ...
                                                          child:
                                                            ...
                                                            onChanged: (String?
                                                              ...
                                                              setState(() {
                                                                ...
                                                                var linkResultYear =
                                                                    '$monthNow/$yearNow/$periodTipe/$tipeCust/$branchCode';
                                                              ...
                                                              rows: List<
                                                                ...
                                                                (indexObj) {
                                                                  ...
                                                                  var textStyleDataTable =
                                                                      TextStyle(
                                                                    color: dataFoaPMA.listMonitoringFoaPMA![indexObj].headerCode ==
                                                                                'TOTAL' ||
                                                                  ...
                                                                  return DataRow(
                                                                    ...
                                                                    cells: <DataCell>[
                                                                      DataCell(
                                                                        InkWell(
                                                                          onTap: dataFoaPMA.listMonitoringFoaPMA![indexObj].headerCode == 'TOTAL' || dataFoaPMA.listMonitoringFoaPMA![indexObj].headerName == 'TOTAL'
                                                                              ? () {}
                                                                              : () {
