                                                                    ...
                                                                    (indexObj) {
                                                                      ...
                                                                      var textStyleDataTable =
                                                                        ...
                                                                        color: dataProspekVSpk.listRptProspekSpk![indexObj].headerCode == 'TOTAL' ||
                                                                                dataProspekVSpk.listRptProspekSpk![indexObj].tipe == 'Sales' ||
                                                                                dataProspekVSpk.listRptProspekSpk![indexObj].headerName == 'TOTAL'
                                                                            ? const Color.fromARGB(
                                                                                255,
                                                                                255,
                                                                                255,
...
class DataProspekVspk {
  ...
  DataProspekVspk(this.x, this.y, this.color);
}
