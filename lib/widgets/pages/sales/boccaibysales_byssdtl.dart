...
class BocCaiBySalesSSDtlPage extends StatefulWidget {
  final Object? linkPageObj;
  const BocCaiBySalesSSDtlPage({super.key, required this.linkPageObj});

  static const String routeName = "/bocCaiBySalesSSDtlPage";
  @override
  State<BocCaiBySalesSSDtlPage> createState() => _BocCaiBySalesSSDtlPageState();
}
...
class _BocCaiBySalesSSDtlPageState extends State<BocCaiBySalesSSDtlPage> {
  ...
  List<ModelKodeTipe> kodeTipeOptions = [
    ModelKodeTipe('ALL', 'ALL'),
    ModelKodeTipe('SBI', 'SBI'),
    ModelKodeTipe('SBI 10K', 'SBE1'),
    ModelKodeTipe('SBI 20K', 'SBE2'),
    ModelKodeTipe('SBI 30K', 'SBE3'),
    ModelKodeTipe('SBI 40K', 'SBE4'),
    ModelKodeTipe('SBI 50K', 'SBE5'),
  ];
              ...
              children: [
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    final rptBocCai =
                        ref.watch(reportBocCaiBySalesSSDtl(linkPageObj));
                            ...
                            children: [
                              Padding(
                                ...
                                child: SizedBox(
                                  child: rptBocCai.when(
                                    data: (dataSelectOpt) {
                                      if (dataSelectOpt.listBocCaiBySales !=
                                          null) {
                                        String tipePeriode = dataSelectOpt
                                                .listBocCaiBySales!.isNotEmpty
                                            ? (linkPageObj ==
                                                    '$monthNow/$yearNow')
                                                ? 'MTD'
                                                : dataSelectOpt
                                        ...
                                        String yearSelected = dataSelectOpt
                                            ...
                                            ? (linkPageObj ==
                                                ...
                                                ? DateFormat('yyyy')
                                                    .format(DateTime.now())
                                                : dataSelectOpt
                                                    .listBocCaiBySales![0].year
                                                    .toString()
                                            : '';

                                        String kodeTipeSelected = dataSelectOpt
                                                .listBocCaiBySales!.isNotEmpty
                                            ? (linkPageObj ==
                                                    '$monthNow/$yearNow')
                                                ? DateFormat('yyyy')
                                                ...
                                                child: Column(
                                                  children: [
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        "Periode : ${dataSelectOpt.listBocCaiBySales![0].monthID} ${dataSelectOpt.listBocCaiBySales![0].year}",
                                                        style: TextStyle(
                                                          color: const Color
                                                              .fromARGB(
                                                            255,
                              ...
                              Expanded(
                                child: RefreshIndicator(
                                  onRefresh: () async {
                                    return ref.refresh(reportBocCaiBySalesSSDtl(
                                  ...
                                  child: rptBocCai.when(
                                    data: (dataBocCai) {
                                      var gContacted = dataBocCai
                                          ...
                                          .persenContacted;
                                      var gBoc = dataBocCai
                                          .listBocCaiBySales![0].persenBoc;
                                      var gCai = dataBocCai
                                          .listBocCaiBySales![0].persenCai;

                                      return (dataBocCai.listBocCaiBySales !=
                                              null)
                                          ? dataBocCai
                                                  .listBocCaiBySales!.isNotEmpty
                                              ? ListView.builder(
